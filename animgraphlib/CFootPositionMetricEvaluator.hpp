...
namespace source2sdk
{
    namespace animgraphlib
    {
        ...
        #pragma pack(push, 1)
        class CFootPositionMetricEvaluator : public source2sdk::animgraphlib::CMotionMetricEvaluator
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animgraphlib::CFootPositionMetricEvaluator) == 0x70);
    };
};
