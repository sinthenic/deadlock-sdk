...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        #pragma pack(push, 1)
        class CSmartPropSelectionCriteria_LinearLength : public source2sdk::smartprops::CSmartPropSelectionCriteria
        {
        public:
        ...
        static_assert(sizeof(source2sdk::smartprops::CSmartPropSelectionCriteria_LinearLength) == 0x148);
    };
};
