...
namespace source2sdk
{
    namespace smartprops
    {
        ...
        public:
            ...
            source2sdk::smartprops::CSmartPropAttributeCoordinateSpace m_CoordinateSpaceA; // 0x118            
            ...
            source2sdk::smartprops::CSmartPropAttributeCoordinateSpace m_CoordinateSpaceB; // 0x198            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::smartprops::CSmartPropOperation_ComputeVectorBetweenPoints3D) == 0x1d8);
    };
};
