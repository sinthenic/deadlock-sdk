...
namespace source2sdk
{
    namespace modellib
    {
        ...
        public:
            ...
            source2sdk::modellib::RenderPrimitiveType_t m_nPrimitiveType; // 0x38            
        ...
        static_assert(offsetof(source2sdk::modellib::CMaterialDrawDescriptor, m_material) == 0x100);
        
        static_assert(sizeof(source2sdk::modellib::CMaterialDrawDescriptor) == 0x108);
    };
};
