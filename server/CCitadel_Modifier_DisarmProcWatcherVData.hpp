...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DisarmProcModifier[0x10]; // 0x7a0            
            ...
            char m_ImmunityModifier[0x10]; // 0x7b0            
            ...
            char m_TracerParticle[0xe0]; // 0x7c0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_DisarmProcWatcherVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_DisarmProcWatcherVData) == 0x8a0);
    };
};
