...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_aPlayerControllers[0x18]; // 0x4f0            
            // metadata: MNetworkEnable
            ...
            char m_aPlayers[0x18]; // 0x508            
            // metadata: MNetworkEnable
            std::int32_t m_iScore; // 0x520            
            // metadata: MNetworkEnable
            char m_szTeamname[129]; // 0x524            
        ...
        static_assert(sizeof(source2sdk::server::CTeam) == 0x5a8);
    };
};
