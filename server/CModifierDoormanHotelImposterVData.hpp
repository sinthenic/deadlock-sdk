...
#include "source2sdk/server/CCitadel_Modifier_Doorman_Hotel_Imposter_FX.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifierDoormanHotelImposterVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
