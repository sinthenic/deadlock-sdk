...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            uint8_t _pad0ca4[0x1c]; // 0xca4
            source2sdk::entity2::GameTime_t m_flLastDeferredDamageApplicationTime; // 0xcc0            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Shiv_Defer_Damage) == 0xcc8);
    };
};
