...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CNPC_FieldSentry_GraphController : public source2sdk::server::CNPC_SimpleAnimatingAI_GraphController
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CNPC_FieldSentry_GraphController) == 0x3e8);
    };
};
