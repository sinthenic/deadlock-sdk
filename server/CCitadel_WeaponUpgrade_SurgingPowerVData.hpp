...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ModifierSurgingPower[0x10]; // 0x1790            
            ...
            char m_CastTargetEffect[0xe0]; // 0x17a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SurgingPowerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_WeaponUpgrade_SurgingPowerVData) == 0x1880);
    };
};
