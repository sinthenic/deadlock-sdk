...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SwapParticle[0xe0]; // 0x1700            
            ...
            char m_SilenceExplodeParticle[0xe0]; // 0x17e0            
            ...
            char m_SwapModifier[0x10]; // 0x18c0            
            ...
            char m_PreCastModifier[0x10]; // 0x18d0            
            ...
            char m_SilenceModifier[0x10]; // 0x18f0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_HealthSwapVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_HealthSwapVData) == 0x1900);
    };
};
