...
namespace source2sdk
{
    namespace server
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CNPC_Trooper_GraphController2 : public source2sdk::client::CAnimGraphControllerBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CNPC_Trooper_GraphController2) == 0x270);
    };
};
