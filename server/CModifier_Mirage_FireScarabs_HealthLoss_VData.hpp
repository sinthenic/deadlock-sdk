...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SiphonParticle[0xe0]; // 0x760            
            ...
            char m_HealModifier[0x10]; // 0x840            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Mirage_FireScarabs_HealthLoss_VData) == 0x850);
    };
};
