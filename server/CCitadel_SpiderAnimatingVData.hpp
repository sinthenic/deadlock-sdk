...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_SpiderAnimatingVData : public source2sdk::client::CEntitySubclassVDataBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_SpiderAnimatingVData) == 0x110);
    };
};
