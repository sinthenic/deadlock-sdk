...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_pOutputOnEntitiesSpawned; // 0x4f0            
            ...
            std::uint32_t m_hLayerSpawnGroup; // 0x52c            
        ...
        static_assert(sizeof(source2sdk::server::CInfoWorldLayer) == 0x530);
    };
};
