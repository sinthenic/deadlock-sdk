...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_hMeasureTarget[0x4]; // 0x9d8            
            uint8_t _pad09dc[0x4]; // 0x9dc
            CUtlSymbolLarge m_iszMeasureTarget; // 0x9e0            
            float m_fRadius; // 0x9e8            
            std::int32_t m_nTouchers; // 0x9ec            
            ...
            char m_NearestEntityDistance[0x28]; // 0x9f0            
        ...
        static_assert(sizeof(source2sdk::server::CTriggerProximity) == 0xa18);
    };
};
