...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_flInCombatWithNeutralDuration) == 0xbe0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStartingStats) == 0xbe8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapScalingStats) == 0xc10);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_groundDashPositionCurve) == 0xc38);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapModCostBonuses) == 0xc78);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapBoundAbilities) == 0xcb8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapWIPAbilities) == 0xce0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapItemSlotInfo) == 0xd08);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapRecommendedUpgradeHints) == 0xd30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgrades) == 0xd80);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedUpgradeTags) == 0xdb0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_RecommendedAbilityOrder) == 0xe30);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eAbilityResourceType) == 0xe60);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strGunTag) == 0xe68);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_vecHeroTags) == 0xe70);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_eHeroType) == 0xe88);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strRosterBackgroundLayout) == 0xe90);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_strHideoutRichPresence) == 0xe98);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapStandardLevelUpUpgrades) == 0xeb8);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapLevelInfo) == 0xee0);
        static_assert(offsetof(source2sdk::server::CitadelHeroData_t, m_mapPurchaseBonuses) == 0xf08);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroData_t) == 0xf30);
    };
};
