...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strWeaponShootSound; // 0x840            
            CSoundEventName m_strBulletWhizSound; // 0x850            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_TargetPracticeSelfVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_TargetPracticeSelfVData) == 0x860);
    };
};
