...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            bool m_bCanHLTVUse; // 0x524            
            // metadata: MNetworkEnable
            bool m_bAlignWithParent; // 0x525            
            // metadata: MNetworkEnable
            bool m_bDofEnabled; // 0x526            
            ...
            source2sdk::server::CPointCamera* m_pNext; // 0x548            
        ...
        static_assert(sizeof(source2sdk::server::CPointCamera) == 0x550);
    };
};
