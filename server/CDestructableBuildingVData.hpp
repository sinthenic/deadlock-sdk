...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_EnemyTrooperDamageReduction;
        ...
        static_assert(sizeof(source2sdk::server::CDestructableBuildingVData) == 0x88);
    };
};
