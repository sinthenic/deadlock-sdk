...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Drifter_Darkness_Target_BoundaryUnit_VData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CModifier_Drifter_Darkness_Target_BoundaryUnit_VData) == 0x860);
    };
};
