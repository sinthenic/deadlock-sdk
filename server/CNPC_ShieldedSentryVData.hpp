...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CNPC_ShieldedSentryVData : public source2sdk::server::CNPC_SimpleAnimatingAIVData
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_KillExplosionParticle;
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_AutoDestructParticle;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_DeployProgressModifier;
            ...
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_IntrinsicModifier;
        ...
        static_assert(sizeof(source2sdk::server::CNPC_ShieldedSentryVData) == 0x448);
    };
};
