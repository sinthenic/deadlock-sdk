...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::soundsystem::soundlevel_t m_iSoundLevel; // 0x4f8            
            source2sdk::server::dynpitchvol_t m_dpv; // 0x4fc            
        ...
        static_assert(sizeof(source2sdk::server::CAmbientGeneric) == 0x598);
    };
};
