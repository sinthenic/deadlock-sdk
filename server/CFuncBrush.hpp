...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::client::BrushSolidities_e m_iSolidity; // 0x808            
            std::int32_t m_iDisabled; // 0x80c            
            bool m_bSolidBsp; // 0x810            
            uint8_t _pad0811[0x7]; // 0x811
            CUtlSymbolLarge m_iszExcludedClass; // 0x818            
            bool m_bInvertExclusion; // 0x820            
            bool m_bScriptedMovement; // 0x821            
        ...
        static_assert(sizeof(source2sdk::server::CFuncBrush) == 0x828);
    };
};
