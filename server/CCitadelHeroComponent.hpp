...
#include "source2sdk/server/CitadelHeroSpawnData_t.hpp"
...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CitadelHeroSpawnData_t m_spawnedHero; // 0x18            
            // metadata: MNetworkEnable
            // metadata: MNetworkPriority "32"
            source2sdk::server::CitadelHeroSpawnData_t m_loadingHero; // 0x28            
            // metadata: MNetworkEnable
        ...
        static_assert(sizeof(source2sdk::server::CCitadelHeroComponent) == 0x40);
    };
};
