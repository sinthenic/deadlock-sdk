...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_onGUIDChanged[0x28]; // 0x510            
            source2sdk::entity2::CEntityIOOutput m_onSoundFinished; // 0x538            
            float m_flClientCullRadius; // 0x560            
            uint8_t _pad0564[0x2c]; // 0x564
            CUtlSymbolLarge m_iszSoundName; // 0x590            
            uint8_t _pad0598[0x14]; // 0x598
            CEntityHandle m_hSource; // 0x5ac            
            std::int32_t m_nEntityIndexSelection; // 0x5b0            
        ...
        static_assert(sizeof(source2sdk::server::CSoundEventEntity) == 0x5b8);
    };
};
