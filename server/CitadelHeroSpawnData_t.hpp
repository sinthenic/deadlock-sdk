...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::CitadelHeroSpawnData_t, m_nHeroID) == 0x8);
        static_assert(offsetof(source2sdk::server::CitadelHeroSpawnData_t, m_unHeroBadgeXP) == 0xc);
        
        static_assert(sizeof(source2sdk::server::CitadelHeroSpawnData_t) == 0x10);
    };
};
