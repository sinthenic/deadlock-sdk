...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_iLane) == 0x3c);
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_eHeight) == 0x40);
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_bVisibleOnMap) == 0x41);
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_bBackdoorProtectionActive) == 0x42);
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_nTickHidden) == 0x44);
        static_assert(offsetof(source2sdk::server::STeamFOWEntity, m_strEntityName) == 0x48);
