...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CNPC_BaseDefenseSentryVData : public source2sdk::server::CNPC_SimpleAnimatingAIVData
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_SentryExplosionParticle;
        ...
        static_assert(sizeof(source2sdk::server::CNPC_BaseDefenseSentryVData) == 0x208);
    };
};
