...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            Color m_TintColor; // 0x4f4            
            // metadata: MNetworkEnable
            float m_flAnisotropy; // 0x4f8            
            // metadata: MNetworkEnable
            float m_flFadeSpeed; // 0x4fc            
            // metadata: MNetworkEnable
            float m_flDrawDistance; // 0x500            
            // metadata: MNetworkEnable
            float m_flFadeInStart; // 0x504            
            // metadata: MNetworkEnable
            float m_flFadeInEnd; // 0x508            
            // metadata: MNetworkEnable
            float m_flIndirectStrength; // 0x50c            
            // metadata: MNetworkEnable
            std::int32_t m_nVolumeDepth; // 0x510            
            // metadata: MNetworkEnable
            float m_fFirstVolumeSliceThickness; // 0x514            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimX; // 0x518            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimY; // 0x51c            
            // metadata: MNetworkEnable
            std::int32_t m_nIndirectTextureDimZ; // 0x520            
            // metadata: MNetworkEnable
            Vector m_vBoxMins; // 0x524            
            // metadata: MNetworkEnable
            Vector m_vBoxMaxs; // 0x530            
            // metadata: MNetworkEnable
            bool m_bActive; // 0x53c            
            uint8_t _pad053d[0x3]; // 0x53d
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartAnisoTime; // 0x540            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartScatterTime; // 0x544            
            // metadata: MNetworkEnable
            source2sdk::entity2::GameTime_t m_flStartDrawDistanceTime; // 0x548            
            // metadata: MNetworkEnable
            float m_flStartAnisotropy; // 0x54c            
            // metadata: MNetworkEnable
            float m_flStartScattering; // 0x550            
            // metadata: MNetworkEnable
            float m_flStartDrawDistance; // 0x554            
            // metadata: MNetworkEnable
            float m_flDefaultAnisotropy; // 0x558            
            // metadata: MNetworkEnable
            float m_flDefaultScattering; // 0x55c            
            // metadata: MNetworkEnable
            float m_flDefaultDrawDistance; // 0x560            
            // metadata: MNetworkEnable
            bool m_bStartDisabled; // 0x564            
            // metadata: MNetworkEnable
            bool m_bEnableIndirect; // 0x565            
            // metadata: MNetworkEnable
            bool m_bIsMaster; // 0x566            
            ...
            char m_hFogIndirectTexture[0x8]; // 0x568            
            // metadata: MNetworkEnable
            std::int32_t m_nForceRefreshCount; // 0x570            
            // metadata: MNetworkEnable
            float m_fNoiseSpeed; // 0x574            
            // metadata: MNetworkEnable
            float m_fNoiseStrength; // 0x578            
            // metadata: MNetworkEnable
            Vector m_vNoiseScale; // 0x57c            
            // metadata: MNetworkEnable
            float m_fWindSpeed; // 0x588            
            // metadata: MNetworkEnable
            Vector m_vWindDirection; // 0x58c            
            bool m_bFirstTime; // 0x598            
        ...
        static_assert(sizeof(source2sdk::server::CEnvVolumetricFogController) == 0x5a0);
    };
};
