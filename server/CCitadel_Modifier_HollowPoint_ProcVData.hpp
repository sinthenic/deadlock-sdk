...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HollowPoint_ProcVData : public source2sdk::server::CCitadel_Modifier_BaseBulletPreRollProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HollowPoint_ProcVData) == 0x990);
    };
};
