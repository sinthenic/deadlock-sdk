...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CAI_MotorGroundAnimGraph_State_Start : public source2sdk::server::CAI_MotorGroundAnimGraph_State
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CAI_MotorGroundAnimGraph_State_Start) == 0x28);
    };
};
