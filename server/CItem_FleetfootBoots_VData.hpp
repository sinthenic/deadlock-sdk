...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_FleetfootBootsModifier[0x10]; // 0x1790            
            ...
            char m_FleetfootBootsBonusClipModifier[0x10]; // 0x17a0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItem_FleetfootBoots_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItem_FleetfootBoots_VData) == 0x17b0);
    };
};
