...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::server::CCitadel_Ability_Frank_ShockTarget* pShockTarget; // 0x108            
            source2sdk::client::ParticleIndex_t m_nStoredDamageFXIndex; // 0x110            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_Frank_StoredDamageWatcher) == 0x118);
    };
};
