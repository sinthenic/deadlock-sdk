...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_HeroTestOrbSpawnerVData : public source2sdk::client::CEntitySubclassVDataBase
        {
        public:
            // metadata: MPropertyStartGroup "Gameplay"
            std::int32_t m_iGoldValue; // 0x28            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_HeroTestOrbSpawnerVData) == 0x2e0);
    };
};
