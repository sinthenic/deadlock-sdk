...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            std::int32_t m_iCurrentMaxPieces; // 0x50c            
            std::int32_t m_iMaxPieces; // 0x510            
            std::int32_t m_iLastFrame; // 0x514            
        ...
        static_assert(sizeof(source2sdk::server::CGameGibManager) == 0x518);
    };
};
