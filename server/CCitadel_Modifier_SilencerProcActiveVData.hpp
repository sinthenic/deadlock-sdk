...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SilencerActiveParticle[0xe0]; // 0x870            
            ...
            char m_SilenceActiveModifier[0x10]; // 0x950            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_SilencerProcActiveVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_SilencerProcActiveVData) == 0x960);
    };
};
