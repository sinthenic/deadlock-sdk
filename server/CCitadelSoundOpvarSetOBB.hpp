...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // metadata: MNetworkEnable
            Vector m_vDistanceInnerMins; // 0x508            
            // metadata: MNetworkEnable
            Vector m_vDistanceInnerMaxs; // 0x514            
            // metadata: MNetworkEnable
            Vector m_vDistanceOuterMins; // 0x520            
            // metadata: MNetworkEnable
            Vector m_vDistanceOuterMaxs; // 0x52c            
            // metadata: MNetworkEnable
            std::int32_t m_nAABBDirection; // 0x538            
        ...
        static_assert(sizeof(source2sdk::server::CCitadelSoundOpvarSetOBB) == 0x540);
    };
};
