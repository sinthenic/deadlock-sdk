...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DamageShareParticle[0xe0]; // 0x1700            
            ...
            char m_DamageShareModifier[0x10]; // 0x17e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Boho_DamageShareVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Boho_DamageShareVData) == 0x17f0);
    };
};
