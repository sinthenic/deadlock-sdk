...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BuffModifier[0x10]; // 0x790            
            ...
            char m_BulletDamageBuffModifier[0x10]; // 0x7a0            
