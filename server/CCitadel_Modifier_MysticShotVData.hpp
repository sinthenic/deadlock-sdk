...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_MysticShotVData : public source2sdk::server::CCitadel_Modifier_BaseBulletPreRollProcVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_MysticShotVData) == 0x980);
    };
};
