...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_HookTargetVData : public source2sdk::server::CCitadel_Modifier_LinkVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_HookTargetVData) == 0x9c8);
    };
};
