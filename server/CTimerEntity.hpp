...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            source2sdk::entity2::CEntityIOOutput m_OnTimer; // 0x4f0            
            source2sdk::entity2::CEntityIOOutput m_OnTimerHigh; // 0x518            
            source2sdk::entity2::CEntityIOOutput m_OnTimerLow; // 0x540            
            std::int32_t m_iDisabled; // 0x568            
            float m_flInitialDelay; // 0x56c            
            float m_flRefireTime; // 0x570            
            bool m_bUpDownState; // 0x574            
            uint8_t _pad0575[0x3]; // 0x575
            std::int32_t m_iUseRandomTime; // 0x578            
            bool m_bPauseAfterFiring; // 0x57c            
            uint8_t _pad057d[0x3]; // 0x57d
            float m_flLowerRandomBound; // 0x580            
            float m_flUpperRandomBound; // 0x584            
            float m_flRemainingTime; // 0x588            
            bool m_bPaused; // 0x58c            
        ...
        static_assert(sizeof(source2sdk::server::CTimerEntity) == 0x590);
    };
};
