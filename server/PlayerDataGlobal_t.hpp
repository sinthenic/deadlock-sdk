...
namespace source2sdk
{
    namespace server
    {
        ...
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bAlive) == 0x64);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_nHeroDraftPosition) == 0x68);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bUltimateTrained) == 0x6c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_flUltimateCooldownStart) == 0x70);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_flUltimateCooldownEnd) == 0x74);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bHasRejuvenator) == 0x78);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bHasRebirth) == 0x79);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_bFlaggedAsCheater) == 0x7a);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iHeroDamage) == 0x7c);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iHeroHealing) == 0x80);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iSelfHealing) == 0x84);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_iObjectiveDamage) == 0x88);
        static_assert(offsetof(source2sdk::server::PlayerDataGlobal_t, m_nHeroAbilityUpgradeBits) == 0x8c);
