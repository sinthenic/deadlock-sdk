...
namespace source2sdk
{
    namespace server
    {
        ...
        {
        public:
            uint8_t _pad04f0[0x1078]; // 0x4f0
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "StateChanged"
            Color m_Entity_Color; // 0x1568            
            // metadata: MNetworkEnable
            // metadata: MNetworkChangeCallback "StateChanged"
            float m_Entity_flBrightness; // 0x156c            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hCubemapTexture[0x8]; // 0x1570            
            // metadata: MNetworkEnable
            bool m_Entity_bCustomCubemapTexture; // 0x1578            
            uint8_t _pad1579[0x7]; // 0x1579
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_AmbientCube[0x8]; // 0x1580            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SDF[0x8]; // 0x1588            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_DC[0x8]; // 0x1590            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_R[0x8]; // 0x1598            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_G[0x8]; // 0x15a0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeTexture_SH2_B[0x8]; // 0x15a8            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightIndicesTexture[0x8]; // 0x15b0            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightScalarsTexture[0x8]; // 0x15b8            
            // metadata: MNetworkEnable
            ...
            char m_Entity_hLightProbeDirectLightShadowsTexture[0x8]; // 0x15c0            
            // metadata: MNetworkEnable
            Vector m_Entity_vBoxMins; // 0x15c8            
            // metadata: MNetworkEnable
            Vector m_Entity_vBoxMaxs; // 0x15d4            
            // metadata: MNetworkEnable
            bool m_Entity_bMoveable; // 0x15e0            
            uint8_t _pad15e1[0x3]; // 0x15e1
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nHandshake; // 0x15e4            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nEnvCubeMapArrayIndex; // 0x15e8            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nPriority; // 0x15ec            
            // metadata: MNetworkEnable
            bool m_Entity_bStartDisabled; // 0x15f0            
            uint8_t _pad15f1[0x3]; // 0x15f1
            // metadata: MNetworkEnable
            float m_Entity_flEdgeFadeDist; // 0x15f4            
            // metadata: MNetworkEnable
            Vector m_Entity_vEdgeFadeDists; // 0x15f8            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeX; // 0x1604            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeY; // 0x1608            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeSizeZ; // 0x160c            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasX; // 0x1610            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasY; // 0x1614            
            // metadata: MNetworkEnable
            std::int32_t m_Entity_nLightProbeAtlasZ; // 0x1618            
            uint8_t _pad161c[0x15]; // 0x161c
            // metadata: MNetworkEnable
            bool m_Entity_bEnabled; // 0x1631            
            uint8_t _pad1632[0x6];
            
            // Datamap fields:
            // void m_Entity_pEnvMap; // 0x1620
            // void m_Entity_pLightProbeVolume; // 0x1628
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CEnvCombinedLightProbeVolume because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CEnvCombinedLightProbeVolume) == 0x1638);
    };
};
