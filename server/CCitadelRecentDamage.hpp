...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            // CHandle<source2sdk::server::CBaseEntity> m_hPlayerEntToStore;
            char m_hPlayerEntToStore[0x4]; // 0x14            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::server::CCitadelRecentDamage, m_flLastDamageTime) == 0x8);
        static_assert(offsetof(source2sdk::server::CCitadelRecentDamage, m_flStartTime) == 0xc);
        static_assert(offsetof(source2sdk::server::CCitadelRecentDamage, m_flEndTime) == 0x10);
        static_assert(offsetof(source2sdk::server::CCitadelRecentDamage, m_hPlayerEntToStore) == 0x14);
        
        static_assert(sizeof(source2sdk::server::CCitadelRecentDamage) == 0x18);
    };
};
