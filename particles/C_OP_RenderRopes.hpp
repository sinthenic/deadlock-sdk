...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particles::ParticleAttributeIndex_t m_nScalarFieldForTextureCoordinate; // 0x3088            
            ...
            uint8_t _pad3092[0x2]; // 0x3092
            // metadata: MPropertyFriendlyName "attribute to use for rope segment id"
            // metadata: MPropertyAttributeChoiceName "particlefield_scalar"
            source2sdk::particles::ParticleAttributeIndex_t m_nSplitField; // 0x3094            
            ...
            bool m_bSortBySegmentID; // 0x3098            
            uint8_t _pad3099[0x3]; // 0x3099
            ...
            source2sdk::particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x309c            
