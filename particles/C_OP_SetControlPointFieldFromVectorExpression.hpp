...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            source2sdk::particleslib::CParticleRemapFloatInput m_flOutputRemap; // 0x1020            
            // metadata: MPropertyFriendlyName "output control point"
            std::int32_t m_nOutputCP; // 0x1180            
            // metadata: MPropertyFriendlyName "output component"
            // metadata: MPropertyAttributeChoiceName "vector_component"
            std::int32_t m_nOutVectorField; // 0x1184            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::particles::C_OP_SetControlPointFieldFromVectorExpression) == 0x1188);
    };
};
