...
namespace source2sdk
{
    namespace particles
    {
        ...
        public:
            ...
            bool m_bSequenceNumbersAreRawSequenceIndices; // 0x2d78            
            uint8_t _pad2d79[0x3]; // 0x2d79
            ...
            source2sdk::particles::ParticleOrientationChoiceList_t m_nOrientationType; // 0x2d7c            
            ...
            std::int32_t m_nOrientationControlPoint; // 0x2d80            
            // metadata: MPropertyFriendlyName "enable yaw for particles aligned to normals"
            // metadata: MPropertySortPriority "750"
            // metadata: MPropertySuppressExpr "m_nOrientationType != PARTICLE_ORIENTATION_ALIGN_TO_PARTICLE_NORMAL && m_nOrientationType != PARTICLE_ORIENTATION_SCREENALIGN_TO_PARTICLE_NORMAL"
            bool m_bUseYawWithNormalAligned; // 0x2d84            
            uint8_t _pad2d85[0x3]; // 0x2d85
