...
namespace source2sdk
{
    namespace particles
    {
        ...
        #pragma pack(push, 1)
        class C_INIT_RemapCPtoScalar : public source2sdk::particles::CParticleFunctionInitializer
        {
        public:
        ...
        static_assert(sizeof(source2sdk::particles::C_INIT_RemapCPtoScalar) == 0x1f8);
    };
};
