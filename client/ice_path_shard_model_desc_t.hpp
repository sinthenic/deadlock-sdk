...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::ice_path_shard_model_desc_t, m_nModelID) == 0x8);
        static_assert(offsetof(source2sdk::client::ice_path_shard_model_desc_t, m_vecPanelSize) == 0xc);
        static_assert(offsetof(source2sdk::client::ice_path_shard_model_desc_t, m_vecPanelVertices) == 0x18);
        static_assert(offsetof(source2sdk::client::ice_path_shard_model_desc_t, m_flThickness) == 0x30);
        static_assert(offsetof(source2sdk::client::ice_path_shard_model_desc_t, m_SurfacePropStringToken) == 0x34);
        
        static_assert(sizeof(source2sdk::client::ice_path_shard_model_desc_t) == 0x38);
    };
};
