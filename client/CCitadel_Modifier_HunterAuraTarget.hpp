...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_HunterAuraTarget : public source2sdk::client::CCitadelModifier
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_HunterAuraTarget) == 0x188);
    };
};
