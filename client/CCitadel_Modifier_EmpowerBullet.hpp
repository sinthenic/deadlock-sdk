...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_EmpowerBullet : public source2sdk::client::CCitadel_Modifier_BaseBulletPreRollProc
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_EmpowerBullet) == 0x220);
    };
};
