...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CModifier_Drifter_ShadowMark_Target : public source2sdk::client::CCitadelModifier
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Drifter_ShadowMark_Target) == 0x148);
    };
};
