...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CitadelStatsSpiritDisplay_t, m_vecDisplayStats) == 0x0);
        
        static_assert(sizeof(source2sdk::client::CitadelStatsSpiritDisplay_t) == 0x18);
    };
};
