...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraCancelledTransitionBacktoArcher; // 0x1700            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraExplodedTransitionBackToArcher; // 0x1788            
            float m_flCameraHoldAtExplosion; // 0x1810            
            float m_flFadeToBlackTime; // 0x1814            
            ...
            char m_GuidedArrowChannelParticle[0xe0]; // 0x19d8            
            ...
            char m_KillCheckModifier[0x10]; // 0x1bc8            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1bd8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flTrackAmount; // 0x1be8            
            float m_flSpeedAccel; // 0x1bec            
            float m_flSpeedDeccel; // 0x1bf0            
            float m_flBaseProjectileSpeed; // 0x1bf4            
            float m_flMaxProjectileSpeed; // 0x1bf8            
            float m_flArrowModelTurnSpringStrength; // 0x1bfc            
            float m_flKillCheckWindow; // 0x1c00            
            float m_flWorldCollideGraceWindow; // 0x1c04            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityGuidedArrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityGuidedArrowVData) == 0x1c08);
    };
};
