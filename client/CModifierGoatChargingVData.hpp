...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifierGoatChargingVData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        // Cannot assert offsets of fields in CModifierGoatChargingVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CModifierGoatChargingVData) == 0x840);
    };
};
