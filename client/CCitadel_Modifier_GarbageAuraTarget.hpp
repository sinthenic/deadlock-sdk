...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_GarbageAuraTarget : public source2sdk::client::CCitadel_Modifier_Stunned
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_GarbageAuraTarget) == 0x168);
    };
};
