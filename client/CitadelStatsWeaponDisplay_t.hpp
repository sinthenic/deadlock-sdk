...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ECitadelWeaponAttributes m_eWeaponAttributes; // 0x28            
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecDisplayStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecOtherDisplayStats;
            char m_vecOtherDisplayStats[0x18]; // 0x48            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_strWeaponNameLocString) == 0x0);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_strWeaponDescLocString) == 0x8);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_strWeaponImage) == 0x10);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_strSecondaryWeaponDescLocString) == 0x20);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_eWeaponAttributes) == 0x28);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_vecDisplayStats) == 0x30);
        static_assert(offsetof(source2sdk::client::CitadelStatsWeaponDisplay_t, m_vecOtherDisplayStats) == 0x48);
        
        static_assert(sizeof(source2sdk::client::CitadelStatsWeaponDisplay_t) == 0x60);
    };
};
