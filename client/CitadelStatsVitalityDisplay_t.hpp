...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CitadelStatsVitalityDisplay_t, m_vecDisplayStats) == 0x0);
        static_assert(offsetof(source2sdk::client::CitadelStatsVitalityDisplay_t, m_vecOtherDisplayStats) == 0x18);
        
        static_assert(sizeof(source2sdk::client::CitadelStatsVitalityDisplay_t) == 0x30);
    };
};
