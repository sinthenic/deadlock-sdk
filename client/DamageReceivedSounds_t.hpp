...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveDefault) == 0x0);
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveNPC) == 0x10);
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveDOT) == 0x20);
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveMeleeNPC) == 0x30);
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveMelee) == 0x40);
        static_assert(offsetof(source2sdk::client::DamageReceivedSounds_t, m_strDamageReceiveShield) == 0x50);
        
        static_assert(sizeof(source2sdk::client::DamageReceivedSounds_t) == 0x60);
    };
};
