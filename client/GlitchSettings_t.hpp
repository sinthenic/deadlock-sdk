...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::GlitchSettings_t, m_flQuantizeStrength) == 0xc);
        static_assert(offsetof(source2sdk::client::GlitchSettings_t, m_flFrameRate) == 0x10);
        static_assert(offsetof(source2sdk::client::GlitchSettings_t, m_flSpeed) == 0x14);
        static_assert(offsetof(source2sdk::client::GlitchSettings_t, m_flJumpStrength) == 0x18);
        static_assert(offsetof(source2sdk::client::GlitchSettings_t, m_flDistortStrength) == 0x1c);
