...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        struct CitadelCameraTargetPosOperationDef_t : public source2sdk::client::CitadelCameraOperationDef_t
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CitadelCameraTargetPosOperationDef_t) == 0xa8);
    };
};
