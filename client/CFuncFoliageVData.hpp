...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CFuncFoliageVData : public source2sdk::client::CEntitySubclassVDataBase
        {
        public:
            ...
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_BulletExitParticle;
        ...
        static_assert(sizeof(source2sdk::client::CFuncFoliageVData) == 0x1e8);
    };
};
