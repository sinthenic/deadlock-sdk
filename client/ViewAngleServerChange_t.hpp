...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::ViewAngleServerChange_t, nType) == 0x30);
        static_assert(offsetof(source2sdk::client::ViewAngleServerChange_t, qAngle) == 0x34);
        static_assert(offsetof(source2sdk::client::ViewAngleServerChange_t, nIndex) == 0x40);
        
        static_assert(sizeof(source2sdk::client::ViewAngleServerChange_t) == 0x48);
    };
};
