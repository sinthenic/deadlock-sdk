...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BarrageCasterModifier[0x10]; // 0x1700            
            ...
            char m_AmpModifier[0x10]; // 0x1710            
            ...
            char m_ShootParticle[0xe0]; // 0x1730            
            ...
            char m_ChannelParticle[0xe0]; // 0x18f0            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProjectileLaunchSound; // 0x19d0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAttackInterval; // 0x19e0            
        ...
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Barrage_VData) == 0x19e8);
    };
};
