...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::entity2::GameTime_t m_flPlaceTime; // 0x58            
            float m_flFadeStartTime; // 0x5c            
            float m_flFadeDuration; // 0x60            
            float m_flLightingOriginOffset; // 0x64            
            std::int32_t m_nVBSlot; // 0x68            
        ...
        static_assert(offsetof(source2sdk::client::CDecalInstance, m_flPlaceTime) == 0x58);
        static_assert(offsetof(source2sdk::client::CDecalInstance, m_flFadeStartTime) == 0x5c);
        static_assert(offsetof(source2sdk::client::CDecalInstance, m_flFadeDuration) == 0x60);
        static_assert(offsetof(source2sdk::client::CDecalInstance, m_flLightingOriginOffset) == 0x64);
        static_assert(offsetof(source2sdk::client::CDecalInstance, m_nVBSlot) == 0x68);
