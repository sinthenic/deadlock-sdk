...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CScaleFunctionAbilityPropertyMultiStatsVData : public source2sdk::client::CScaleFunctionVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CScaleFunctionAbilityPropertyMultiStatsVData) == 0x58);
    };
};
