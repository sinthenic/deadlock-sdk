...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ProcParticle[0xe0]; // 0x1700            
            ...
            char m_ShieldBreakModifier[0x10]; // 0x17f0            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Priest_AntiSpiritVestVData) == 0x1810);
    };
};
