...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ProcReadyParticle[0xe0]; // 0x760            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProcReadySound; // 0x840            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Mirage_SandPhantom_ProcReady_VData) == 0x850);
    };
};
