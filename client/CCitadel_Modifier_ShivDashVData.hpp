...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DashParticle[0xe0]; // 0x760            
            ...
            char m_DashEchoParticle[0xe0]; // 0x840            
            ...
            char m_DashTrailParticle[0xe0]; // 0x920            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Modifier_ShivDashVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_ShivDashVData) == 0xa00);
    };
};
