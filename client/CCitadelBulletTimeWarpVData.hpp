...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CCitadelBulletTimeWarpVData : public source2sdk::client::CEntitySubclassVDataBase
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadelBulletTimeWarpVData) == 0x1e8);
    };
};
