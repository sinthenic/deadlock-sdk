...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::EMantleType m_eMantleType; // 0x1c            
        ...
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flMinHeight) == 0x8);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flAnimHeight) == 0xc);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flMaxHeight) == 0x10);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flVerticalTime) == 0x14);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flHorizontalTime) == 0x18);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_eMantleType) == 0x1c);
        static_assert(offsetof(source2sdk::client::MantleType_t, m_flSlideExitBoostOnGround) == 0x28);
        
        static_assert(sizeof(source2sdk::client::MantleType_t) == 0x30);
    };
};
