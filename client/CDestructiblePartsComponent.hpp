...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CDestructiblePartsComponent, m_nLastHitDamageLevel) == 0x64);
        
        static_assert(sizeof(source2sdk::client::CDestructiblePartsComponent) == 0x68);
    };
};
