...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BounceModifier[0x10]; // 0x1700            
            ...
            char m_AllyBounceModifier[0x10]; // 0x1710            
            ...
            char m_SpeedOnLandModifier[0x10]; // 0x1720            
            ...
            char m_NoBounceModifier[0x10]; // 0x1730            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityBouncePadVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityBouncePadVData) == 0x1740);
    };
};
