...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::client::SectionProperties_t> m_vecAbilityPropertiesBlock;
        ...
        static_assert(offsetof(source2sdk::client::AbilitySectionInfo_t, m_strLocString) == 0x0);
        static_assert(offsetof(source2sdk::client::AbilitySectionInfo_t, m_vecAbilityPropertiesBlock) == 0x8);
        static_assert(offsetof(source2sdk::client::AbilitySectionInfo_t, m_vecBasicProperties) == 0x20);
        static_assert(offsetof(source2sdk::client::AbilitySectionInfo_t, m_strAbilityPropertyUpgradeRequired) == 0x38);
        
        static_assert(sizeof(source2sdk::client::AbilitySectionInfo_t) == 0x40);
    };
};
