...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            source2sdk::client::ParticleIndex_t m_nTargetingParticleIndex; // 0xd94            
            // metadata: MNetworkEnable
            bool m_bAirRaiding; // 0xd98            
            uint8_t _pad0d99[0x107];
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_PowerJump because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_PowerJump) == 0xea0);
    };
};
