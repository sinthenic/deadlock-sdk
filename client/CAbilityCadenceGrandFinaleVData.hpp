...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_StageModel[0xe0]; // 0x1700            
            float m_flStageModelHeight; // 0x17e0            
            float m_flStageModelWidth; // 0x17e4            
            float m_flStageModelLength; // 0x17e8            
            float m_flStageModelScale; // 0x17ec            
            ...
            char m_GrandFinaleAOEModifier[0x10]; // 0x17f0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityCadenceGrandFinaleVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityCadenceGrandFinaleVData) == 0x1800);
    };
};
