...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_PowerUp_Movement : public source2sdk::client::CCitadel_Modifier_ScalingPowerUp
        {
        public:
            bool m_bFilled; // 0xc0            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_PowerUp_Movement) == 0xc8);
    };
};
