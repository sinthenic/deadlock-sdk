...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strPlayerKillAssist) == 0x30);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strBossKill) == 0x40);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strLaneTrooperKill) == 0x50);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strNeutralTrooperKill) == 0x60);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strBaseSentryKill) == 0x70);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strPlayerOrb) == 0x80);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strOrbDeny) == 0x90);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strLaneTrooperOrb) == 0xa0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strNeutralTrooperOrb) == 0xb0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strTier1BossOrb) == 0xc0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strTier2BossOrb) == 0xd0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strTier3BossOrb) == 0xe0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strBaseSentryOrb) == 0xf0);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strOrbDeployable) == 0x100);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strNeutralBossKill) == 0x110);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strTrophyKillOrb) == 0x120);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strNeutralWorldPickup) == 0x130);
        static_assert(offsetof(source2sdk::client::GoldChangeSounds_t, m_strItemPurchase) == 0x140);
