...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_MagicianTurret_GraphController : public source2sdk::client::CBaseAnimGraphAnimGraphController
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_MagicianTurret_GraphController) == 0x3a8);
    };
};
