...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::client::CitadelCameraDistanceOperationDef_t> m_vecDistanceOperations;
            ...
            // CUtlVector<source2sdk::client::CitadelCameraFOVOperationDef_t> m_vecFOVOperations;
            ...
            // CUtlVector<source2sdk::client::CitadelCameraTargetPosOperationDef_t> m_vecTargetPosOperations;
            ...
            // CUtlVector<source2sdk::client::CitadelCameraVertOffsetOperationDef_t> m_vecVertOffsetOperations;
            ...
            // CUtlVector<source2sdk::client::CitadelCameraHorizOffsetOperationDef_t> m_vecHorizOffsetOperations;
            char m_vecHorizOffsetOperations[0x18]; // 0x70            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_strToken) == 0x0);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_bIsEmpty) == 0x4);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_nPriority) == 0x8);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_vecDistanceOperations) == 0x10);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_vecFOVOperations) == 0x28);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_vecTargetPosOperations) == 0x40);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_vecVertOffsetOperations) == 0x58);
        static_assert(offsetof(source2sdk::client::CitadelCameraOperationsSequence_t, m_vecHorizOffsetOperations) == 0x70);
        
        static_assert(sizeof(source2sdk::client::CitadelCameraOperationsSequence_t) == 0x88);
    };
};
