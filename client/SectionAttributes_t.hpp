...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::client::AbilityPropertyInfo_t> m_vecImportantAbilityProperties;
        ...
        static_assert(offsetof(source2sdk::client::SectionAttributes_t, m_strLocString) == 0x0);
        static_assert(offsetof(source2sdk::client::SectionAttributes_t, m_vecImportantAbilityProperties) == 0x8);
        static_assert(offsetof(source2sdk::client::SectionAttributes_t, m_bRemoveAttributesBackgroundColor) == 0x20);
        static_assert(offsetof(source2sdk::client::SectionAttributes_t, m_vecElevatedAbilityProperties) == 0x28);
        static_assert(offsetof(source2sdk::client::SectionAttributes_t, m_vecAbilityProperties) == 0x40);
        
        static_assert(sizeof(source2sdk::client::SectionAttributes_t) == 0x58);
    };
};
