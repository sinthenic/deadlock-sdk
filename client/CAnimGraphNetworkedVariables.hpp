...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetBoolVariables) == 0x8);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetByteVariables) == 0x20);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetUInt16Variables) == 0x38);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetIntVariables) == 0x50);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetUInt32Variables) == 0x68);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetUInt64Variables) == 0x80);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetFloatVariables) == 0x98);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetVectorVariables) == 0xb0);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetQuaternionVariables) == 0xc8);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_PredNetGlobalSymbolVariables) == 0xe0);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetBoolVariables) == 0xf8);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetByteVariables) == 0x110);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetUInt16Variables) == 0x128);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetIntVariables) == 0x140);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetUInt32Variables) == 0x158);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetUInt64Variables) == 0x170);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetFloatVariables) == 0x188);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetVectorVariables) == 0x1a0);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetQuaternionVariables) == 0x1b8);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_OwnerOnlyPredNetGlobalSymbolVariables) == 0x1d0);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_nBoolVariablesCount) == 0x1e8);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_nOwnerOnlyBoolVariablesCount) == 0x1ec);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_nRandomSeedOffset) == 0x1f0);
        static_assert(offsetof(source2sdk::client::CAnimGraphNetworkedVariables, m_flLastTeleportTime) == 0x1f4);
        
        static_assert(sizeof(source2sdk::client::CAnimGraphNetworkedVariables) == 0x1490);
    };
};
