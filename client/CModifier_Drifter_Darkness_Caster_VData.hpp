...
namespace source2sdk
{
    namespace client
    {
        ...
        #pragma pack(push, 1)
        class CModifier_Drifter_Darkness_Caster_VData : public source2sdk::client::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CModifier_Drifter_Darkness_Caster_VData) == 0x930);
    };
};
