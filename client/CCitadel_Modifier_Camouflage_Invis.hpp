...
namespace source2sdk
{
    namespace client
    {
        ...
        // Has VTable
        #pragma pack(push, 1)
        class CCitadel_Modifier_Camouflage_Invis : public source2sdk::client::CCitadel_Modifier_Invis
        {
        public:
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Modifier_Camouflage_Invis) == 0x330);
    };
};
