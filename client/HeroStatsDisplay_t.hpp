...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecWeaponHeaderStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecWeaponStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecHealthHeaderStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecHealthStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecMagicHeaderStats;
            ...
            // CUtlVector<source2sdk::client::EStatsType> m_vecMagicStats;
            char m_vecMagicStats[0x18]; // 0x78            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecWeaponHeaderStats) == 0x0);
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecWeaponStats) == 0x18);
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecHealthHeaderStats) == 0x30);
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecHealthStats) == 0x48);
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecMagicHeaderStats) == 0x60);
        static_assert(offsetof(source2sdk::client::HeroStatsDisplay_t, m_vecMagicStats) == 0x78);
        
        static_assert(sizeof(source2sdk::client::HeroStatsDisplay_t) == 0x90);
    };
};
