...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            // CUtlOrderedMap<source2sdk::client::ECitadelPingWheelMessageType_t,CUtlVector<CUtlString>> m_mapPingMessages;
            char m_mapPingMessages[0x28]; // 0x0            
        };
        #pragma pack(pop)
        
        static_assert(offsetof(source2sdk::client::CitadelPingWheelMessagesVDATA_t, m_mapPingMessages) == 0x0);
        
        static_assert(sizeof(source2sdk::client::CitadelPingWheelMessagesVDATA_t) == 0x28);
    };
};
