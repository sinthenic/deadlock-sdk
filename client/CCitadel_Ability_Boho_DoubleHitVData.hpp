...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CSoundEventName m_strSlashSound; // 0x18d0            
            CSoundEventName m_strHitConfirmSound; // 0x18e0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Boho_DoubleHitVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Boho_DoubleHitVData) == 0x18f0);
    };
};
