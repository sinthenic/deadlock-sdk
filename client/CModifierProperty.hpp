...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bModifierStatesDirty) == 0x1b7);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bPredictedOwner) == 0x1b8);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_bAllowModifiersOnDeadEntities) == 0x1b9);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_iLockRefCount) == 0x1ba);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_hHandle) == 0x1bc);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_nBroadcastEventListenerMask) == 0x1c0);
        static_assert(offsetof(source2sdk::client::CModifierProperty, m_nCachedHighestParticleIndex) == 0x1c4);
