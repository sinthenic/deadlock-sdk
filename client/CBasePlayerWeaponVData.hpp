...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_iPosition) == 0x41c);
        static_assert(offsetof(source2sdk::client::CBasePlayerWeaponVData, m_aShootSounds) == 0x420);
        
        static_assert(sizeof(source2sdk::client::CBasePlayerWeaponVData) == 0x448);
    };
};
