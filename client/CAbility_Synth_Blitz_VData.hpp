...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_BlitzModifier[0x10]; // 0x1700            
            ...
            char m_TechAmpModifier[0x10]; // 0x1710            
            ...
            char m_SlowParticle[0xe0]; // 0x1720            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProcSound; // 0x1800            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbility_Synth_Blitz_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbility_Synth_Blitz_VData) == 0x1810);
    };
};
