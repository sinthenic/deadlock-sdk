...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmFloatCurveNode_CDefinition : public source2sdk::animlib::CNmFloatValueNode_CDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animlib::CNmFloatCurveNode_CDefinition) == 0x58);
    };
};
