...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmIDEventNode_CDefinition : public source2sdk::animlib::CNmIDValueNode_CDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animlib::CNmIDEventNode_CDefinition) == 0x20);
    };
};
