...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmCachedFloatNode_CDefinition : public source2sdk::animlib::CNmFloatValueNode_CDefinition
        {
        public:
        ...
        static_assert(sizeof(source2sdk::animlib::CNmCachedFloatNode_CDefinition) == 0x18);
    };
};
