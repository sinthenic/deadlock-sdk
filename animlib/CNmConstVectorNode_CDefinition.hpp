...
namespace source2sdk
{
    namespace animlib
    {
        ...
        #pragma pack(push, 1)
        class CNmConstVectorNode_CDefinition : public source2sdk::animlib::CNmVectorValueNode_CDefinition
        {
        public:
            Vector m_value; // 0x10            
        ...
        static_assert(sizeof(source2sdk::animlib::CNmConstVectorNode_CDefinition) == 0x20);
    };
};
