...
namespace source2sdk
{
    namespace soundsystem_lowlevel
    {
        ...
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_fldbLimiterThreshold) == 0xc);
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_fldbKneeWidth) == 0x10);
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_flRatio) == 0x14);
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_flLimiterRatio) == 0x18);
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_flAttackTimeMS) == 0x1c);
        static_assert(offsetof(source2sdk::soundsystem_lowlevel::VMixDynamicsDesc_t, m_flReleaseTimeMS) == 0x20);
